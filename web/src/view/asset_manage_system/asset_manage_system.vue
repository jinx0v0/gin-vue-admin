<template>
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item label="系统名称">
          <el-input placeholder="搜索条件" v-model="searchInfo.asset_system_name" />
        </el-form-item>    
        <el-form-item label="产品经理">
          <el-input placeholder="搜索条件" v-model="searchInfo.asset_system_manager" />
        </el-form-item>    
        <el-form-item label="域名">
          <el-input placeholder="搜索条件" v-model="searchInfo.asset_system_domain" />
        </el-form-item>    
        ...
        <el-form-item label="内网端口">
          <el-input placeholder="搜索条件" v-model="searchInfo.intranet_port" />
            ...
            <el-select v-model="searchInfo.is_test_environment" clear placeholder="请选择">
                <el-option
                    key="true"
                    label="是"
                    value="true">
        ...
        <el-form-item label="web状态码">
          <el-input placeholder="搜索条件" v-model="searchInfo.web_status_code" />
        </el-form-item>      
            <el-form-item label="重点资产" prop="is_important_asset">
            <el-select v-model="searchInfo.is_important_asset" clear placeholder="请选择">
                <el-option
                    key="true"
                    label="是"
                    value="true">
    ...
    >
      ...
      <el-table-column label="产品经理" prop="asset_system_manager" width="120" /> 
      ...
      <el-table-column label="归属测试环境" prop="is_test_environment" width="120">
        <template slot-scope="scope">{{scope.row.is_test_environment|formatBoolean}}</template>
      </el-table-column>
      ...
      <el-table-column label="重点资产" prop="is_important_asset" width="120">
        <template slot-scope="scope">{{scope.row.is_important_asset|formatBoolean}}</template>
      </el-table-column>
      <el-table-column label="备注" prop="more_record" width="120" /> <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button size="small" type="primary" icon="el-icon-edit" class="table-button" @click="updateAsset_manage_system(scope.row)">变更</el-button>
